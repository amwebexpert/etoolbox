...
export interface ColorsFamily {
    family: string;
    colors: ColorInfo[];
}

export const NAMED_COLORS: ColorsFamily[] = [
    {
        family: 'Blue',
        colors:
            [
    ...
    {
        family: 'Purple, violet, and magenta colors',
        colors:
            [
                {
                    htmlName: 'Indigo',
...
export const FAMILY_NAMES = NAMED_COLORS.map(colorsFamily => colorsFamily.family).sort();
